...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-accent/10 blur-[100px] animate-glow-pulse"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="glass rounded-3xl p-8 md:p-14 relative overflow-hidden">
            ...
            <h1
              className="font-heading text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight leading-[1.05] mb-4 opacity-0 animate-fade-up"
            ...
            >
              ...
              <span className="border-r-2 ml-1 animate-typing-cursor border-accent" />
            </div>
            ...
            >
              <a
                href="#projects"
                className="hero-glow-btn inline-flex items-center gap-2 text-sm"
              >
                <Flame size={16} />
                View Projects
              </a>
